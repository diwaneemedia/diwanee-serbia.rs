  ...
  <div class="social">
    ...
    <div class="social__btn social__facebook">
      <a href="https://www.facebook.com/diwaneeserbia/" target="_blank">
        <svg class='fb-social' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5.914 12.688">
          <path
            id="facebook-footer"
    ...
    <div class="social__btn social__twitter">
      <a href="https://twitter.com/diwaneeserbia" target="_blank">
        <svg class='tw-social' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.178 12.33">
          <path
            id="twitter-footer"
